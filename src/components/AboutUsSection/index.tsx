      ...
      <div className={styles.container}>
        ...
        <div className={styles.videoBorder}>
          ...
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/dVpOgtpnPCw?rel=0&showinfo=0&autoplay=1&mute=1&loop=1&playlist=dVpOgtpnPCw"
            ...
            <div key={`about-us-${item.id}`} className={styles.paragraph}>
              {item.arr.map(text => {
                if (text.hasOwnProperty("list")) {
                  return (
                    <>
                      <br />
                      <li
                        key={`about-us-${item.id}-${text.text}`}
                        className={`${styles.text} ${
                          text.pink ? styles.pink : ""
                        }`}
                ...
                return (
                  <span
                    key={`about-us-${item.id}-${text.text}`}
                    className={`${styles.text} ${text.pink ? styles.pink : ""}`}
                  >
                    {text.text}
                  </span>
                )
